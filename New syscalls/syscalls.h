...
int __sys_setsockopt(int fd, int level, int optname, char __user *optval,
		int optlen);
asmlinkage long sys_syscall1(pid_t pid);
asmlinkage long sys_syscall2(pid_t pid);
asmlinkage long sys_syscall3(pid_t pid);
asmlinkage long sys_syscall4(void);
asmlinkage long sys_syscall5(void);
asmlinkage long sys_syscall6(void);
#endif
